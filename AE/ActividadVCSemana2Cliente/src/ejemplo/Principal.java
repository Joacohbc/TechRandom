...
public class Principal {
	...
	public static void main(String[] args) throws NamingException {
		...
		CarritoDeComprasBeanRemote carritoBean = (CarritoDeComprasBeanRemote) 
				InitialContext.doLookup("/ActividadVCSemana2Beans/CarritoDeComprasBean!com.servicios.CarritoDeComprasBeanRemote");
		
		GestionComprasBeanRemote gestionBean = (GestionComprasBeanRemote)
				InitialContext.doLookup("/ActividadVCSemana2Beans/GestionComprasBean!com.servicios.GestionComprasBeanRemote");
		
		// Problema 1
		// Nos tira un error al tratar user Clases de Java noramles en metodos de los EJBs
